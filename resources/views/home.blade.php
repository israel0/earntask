...
<html lang="en">
  ...
  <body class="w-full relative">
    ...
    <main>
      <div
        ...
        >
          <div class="swiper-wrapper relative">
            <!-- Slides -->
            <div class="swiper-slide swiper_slide_one flex flex-col items-center">
              <div class="mx-auto max-w-[1520px] flex flex-col items-center mt-[10rem] lg:mt-[20rem] gap-8 text-center w-[80%] lg:w-[50%]">
                ...
                <a href="{{ route("register") }}" class="contactButton mt-10 text-base lg:text-xl">
                  Get started
            ...
            <div class="swiper-slide swiper_slide_two flex flex-col items-center">
              <div class="mx-auto max-w-[1520px] flex flex-col items-center mt-[10rem] lg:mt-[20rem] gap-8 text-center w-[80%] lg:w-[50%]">
                <h1
                  class="text-3xl lg:text-6xl text-white font-bold drop-shadow-lg capitalize leading-snug"
                >
                empower your business - invest in the tapestry of success!
                </h1>
                <p class="text-md md:text-xl text-white tracking-wide drop-shadow-lg capitalize">
                  In this exploration of business empowerment, delve into the world of cutting-edge technologies that redefine industries and streamline operations. Discover how investing in state-of-the-art solutions can position your business at the forefront of innovation, enhancing efficiency and competitiveness
                </p>
                <a href="{{ route("register") }}" class="contactButton mt-10 text-base lg:text-xl">
                  Get started
                  <div class="iconButton">
            ...
            <div class="swiper-slide swiper_slide_three flex flex-col items-center">
              <div class="mx-auto max-w-[1520px] flex flex-col items-center mt-[10rem] lg:mt-[15rem] gap-8 text-center w-[80%] lg:w-[50%]">
                <h1
                  class="text-3xl lg:text-6xl text-white font-bold drop-shadow-lg capitalize leading-snug"
                >
                unveiling the essence of africa - from fashion to real estate, tourism and lots more!
                </h1>
                <p
                  class="text-md md:text-xl text-white tracking-wide drop-shadow-lg capitalize"
                >
                Delve into the bustling realm of African real estate, where architectural marvels and sustainable living converge. Navigate the burgeoning markets and transformative developments that define the essence of Africa's real estate landscape, creating spaces that mirror the region's rich cultural tapestry.
                </p>
                <a href="{{ route("register") }}" class="contactButton mt-10 text-base lg:text-xl">
                  Get started
                  <div class="iconButton">
      ...
      <section>
        <div class="flex flex-col relative h-[80svh] lg:h-[400px]">
          <div class="h-[100%] lg:h-[50%] min-w-full lg:min-w-[1200px] lg:max-w-[1520px] mx-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-10 text-center border-[lime]">
            ...
            <a href="invest.html" class="bg-white p-5 rounded-3xl flex flex-col items-center justify-center shadow-lg w-[80%] md:w-full mx-auto">
              <div class="flex flex-col gap-2">
    ...
    <section>
      <div class="flex flex-col lg:flex-row gap-10 lg:mt-10 max-w-[1520px] mx-auto lg:h-[500px] w-full ">
        ...
        <div class="flex flex-col gap-4 basis-1/2 px-5 lg:pe-20 banner2 animate__animated animate__zoomInn">
          <h1 class="text-3xl lg:text-5xl text-[#283618] font-bold"><span class="text-[#FC8400]">Welcome</span> to Paulano Graceland Africa</h1>
    ...
    <section>
      ...
      >
        <div data-scroll id="myplan" class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-5 lg:px-20 animate__animated animate__slow"></div>
      </div>
    </section>
...
ScrollOut({
    ...
    el2.classList.add("animate__zoomIn");
      ...
      const ecosystemArray = [
        ...
        {
          title: "tourism",
          content: "Embark on unforgettable adventures with our bespoke tourism plans. We invite you to explore the wonders of Africa, from the ancient mysteries to modern marvels, ensuring every journey is a celebration of diverse landscapes and cultural treasures",
          icon: "",
